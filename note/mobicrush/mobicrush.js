...
//		imgtag = ' <span class="thumb" style = "background-image: url(' + img[0].src + ');" ></span> ';
		imgtag = ' <img class="thumb" style = "background-image: url(' + img[0].src + ');" src="https://4.bp.blogspot.com/-Z6PBCE1jElk/WDuxI4fNsrI/AAAAAAAAACc/z1nRAF_AWg8Y10LPURGumZF6h2pfGA5MQCLcB/s1600/cover.png"></img> ';
